    ...
    <div className="bg-[#141414]/80 border border-[#2A2A2A]/60 rounded-2xl overflow-hidden">
        ...
        <div className="flex items-center justify-between">
          ...
          {post?.userId?.id !== userId && (
            <Button
              ...
              className={newData?.data?.following?.some((f: any) => f === post?.userId?.id) ? "bg-[#2A2A2A]" : ""}
      ...
      <div className="px-4 py-3 border-t border-[#2A2A2A]">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-1">
            <button
              className={`flex items-center gap-1.5 px-3 py-2 rounded-lg text-sm transition-colors ${
                isLiked ? "text-[#D98E04] bg-[#D98E04]/10" : "text-gray-400 hover:bg-[#2A2A2A]"
              }`}
            ...
            <button
              className={`flex items-center gap-1.5 px-3 py-2 rounded-lg text-sm transition-colors ${
                isDisliked ? "text-red-400 bg-red-500/10" : "text-gray-400 hover:bg-[#2A2A2A]"
              }`}
            ...
            <button className="flex items-center gap-1.5 px-3 py-2 rounded-lg text-sm text-gray-400 hover:bg-[#2A2A2A] transition-colors">
              <FaComment size={16} />
          ...
          <div className="flex items-center gap-1">
            <button
              className="p-2 rounded-lg text-gray-400 hover:bg-[#2A2A2A] hover:text-yellow-400 transition-colors"
              onClick={() => handleSavePost(post?.id)}
            >
              <FaBookmark size={18} />
            </button>
            <button className="p-2 rounded-lg text-gray-400 hover:bg-[#2A2A2A] hover:text-[#D98E04] transition-colors">
              <FaShare size={18} />
            </button>
          </div>
        </div>
                    ...
                    {userId === comment?.author?.id && (
                      <div className="flex gap-1">
                        <button
                          ...
                          className="text-xs text-gray-500 hover:text-[#D98E04]"
                        >
                          Edit
                        </button>
                        <button
        ...
        <div className="flex gap-2">
          ...
          <div className="flex-1 flex gap-2">
            <Input
              ...
              className="flex-1"
              classNames={{
                inputWrapper: "bg-[#2A2A2A] border-[#2A2A2A]/60",
              }}
            />
            <Button
              size="sm"
